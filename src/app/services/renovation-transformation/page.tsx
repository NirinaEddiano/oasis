...
const currentService = servicesData.find(service => service.slug === 'renovation-transformation');
  ...
  return (
    <>
      ...
      <ServiceContentSection
        ...
        imageOnRight={true} // Image à gauche, texte à droite
      />
      <ServiceDetailSection
        ...
        imageOnLeft={false} // Images à gauche, texte à droite
      />
